class Play extends Phaser.Scene{
    ...
    update(){
        ...
        // check collisions
        if(this.checkCollision(this.p1Rocket, this.ship01)){console.log("kaboom ship 01")}
        if(this.checkCollision(this.p1Rocket, this.ship02)){console.log("kaboom ship 02")}
        if(this.checkCollision(this.p1Rocket, this.ship03)){console.log("kaboom ship 03")}
    }
